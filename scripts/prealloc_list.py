"""
Measure performance of appending elements to an empty list. Pre-allocating a
list of known size and assigning items to it gives better performance than
appending to an empty list. The list comprehension approach (Example 3) gives
